(function (factory) {
    ...
    wms.Source = L.Layer.extend({
        options: {untiled: true, identify: true}, initialize: function (url, options) {
    ...
    wms.Overlay = L.Layer.extend({
        ...
        options: {crs: null, uppercase: false, attribution: "", opacity: 1, isBack: false, minZoom: 0, maxZoom: 18},
    ...
    function ajax(url, callback) {
        var context = this, request = new XMLHttpRequest;
